...
> Guide to Shipfast's reporting system, export modes, filters, and scheduling
...
### Q: What types of reports are available in Shipfast?
**A:** Shipfast offers various report types:
...
### ⚠️ Critical: Two Report Generation Modes

Shipfast uses two different backends for generating reports:
