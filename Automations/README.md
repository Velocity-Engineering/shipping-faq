...
Welcome to the Automations FAQ section. Shipfast's Automations help you automatically communicate with your customers to improve delivery success rates and reduce RTO (Return to Origin).

## What are Automations?

Automations are intelligent workflows that automatically reach out to your customers at key moments in the shipping journey using:
...
**[View Order Confirmation FAQs](./order_confirmation/)**
...
**[View NDR Management FAQs](./ndr_management/)**
...
**A:** Navigate to **Settings > Automations** in your Shipfast dashboard. You'll see toggles for Order Confirmation and NDR Management automations. Click the toggle to enable the automation you want to use.
...
#### Q: What is Vani AI?
**A:** Vani AI is Shipfast's intelligent voice agent that sounds natural and can have real conversations with your customers. It can confirm orders, collect address updates, understand delivery preferences, and handle common queries.
...
- [Order Confirmation Automation](./order_confirmation/) - Detailed FAQs on order verification
- [NDR Management Automation](./ndr_management/) - Detailed FAQs on NDR handling
