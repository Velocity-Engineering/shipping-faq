---
title: Webhooks
description: Receive real-time notifications about shipment status changes
---
...
- **Fallback to pull API**: If webhooks fail or are delayed, periodically poll the [Order Details API](/api-docs/order-details-forward) as a backup
