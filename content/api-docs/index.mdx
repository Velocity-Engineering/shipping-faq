---
title: Introduction
description: Complete reference to the Velocity Shipping API suite for custom integrations with websites, ERPs, or order management systems.
---
...
All API requests (except the auth-token endpoint) require authentication using a Bearer token. Obtain your token using the [Authentication API](/api-docs/authentication) and include it in the `Authorization` header of all subsequent requests.
