...
description: Set up and configure a custom-branded tracking page for your customers with your logo, support links, social media, and promotional banners — and understand how billing works.
---
...
## 2. Basic vs. Advanced Tracking Page

### Q: What's the difference between the basic tracking page and the Advanced (Branded) Tracking Page?

**A:** Every Velocity account gets a basic tracking page at no extra cost. The Advanced Tracking Page is a paid VAS add-on that unlocks full visual customization.

| Feature | Basic (All Accounts) | Advanced / Branded (VAS) |
|---------|---------------------|--------------------------|
| Custom subdomain (`yourstore.track.velocity.in`) | ✅ | ✅ |
| Brand logo | ✅ | ✅ |
| Brand name | ✅ | ✅ |
| Support email, phone, and support link | ✅ | ✅ |
| Website URL and return policy link | ✅ | ✅ |
| **Custom header navigation menu** | ❌ | ✅ |
| **Sticky bars (header and footer)** | ❌ | ✅ |
| **Footer social media links** | ❌ | ✅ |
| **Promotional banners (desktop + mobile)** | ❌ | ✅ |

### Q: What social media platforms can I link in the footer?
**A:** With the Advanced Tracking Page, the footer supports: Instagram, YouTube, Facebook, Pinterest, and Twitter/X.

### Q: What are Promotional Banners?
**A:** Banners are clickable image panels on your tracking page — ideal for promotions, new arrivals, or referral campaigns. You can upload separate images for desktop and mobile, and set a click-through URL for each banner.

### Q: What is the Sticky Bar?
**A:** The Sticky Bar is a persistent strip anchored to the top or bottom of the page as customers scroll. It's useful for time-sensitive promotions or support announcements. Separate sticky bars can be configured for the header and footer.
...
### Q: Will I be charged for the same shipment twice?
...
### Q: Where can I see the Branded Tracking Page charges?
**A:** Go to **Payments → Invoices** in your dashboard. The itemized VAS bill lists each `Branded Tracking Page` charge with the associated AWB number and date.
...
- [Value Added Services (VAS)](/vas) — Billing and pricing for all VAS features
