...
|--------------|-----------------|
| **Most carriers** | Labels are generated by Shipfast and fully customizable |
| **Amazon Transportation System (ATS)** | Labels are provided by Amazon and have limited customization |

For **most carriers**, Shipfast generates the labels, so you have full control over:
- Hiding GST/tax information
- Logo placement
- Address formatting
- Barcode styles
- And all other label settings

For **ATS (Amazon Transportation System)**, Amazon sends their own labels through their APIs. While some settings like hiding GST may work, **not all label configurations apply** to ATS labels since they're not generated by Shipfast.

---

### Q: Can I customize what appears on my shipping labels?
**A:** Yes, for most carriers! Go to **Settings → Label Configuration** to customize:

- Show/hide seller GST number
- Show/hide product prices
- Add your logo
- Change address formatting
- Customize barcode placement
- And more

**Important:** 
- These settings only apply to **labels generated by Shipfast**
...
### Q: Why didn't my label configuration changes apply to my order?
**A:** Label configuration changes only apply to **orders/shipments going forward**. They do not apply retrospectively to:
- Already manifested shipments
- Labels that were already generated
- Orders processed before the configuration change

**Solution:** If you need updated labels, you'll need to cancel and rebook the shipment (if the carrier allows).
...
### Q: Why does my ATS (Amazon) label look different?
**A:** ATS (Amazon Transportation System) requires their own label format. These labels:
- Are sent by Amazon through their book shipment APIs
- Are **not generated by Shipfast**
- Have **limited customization** compared to other carriers
- May not reflect all your label configuration settings

**What still works with ATS:** Some basic settings like hiding GST may apply.

**What doesn't work with ATS:** Advanced customizations like logo placement, custom formatting, and other Shipfast-specific label options.

---

### Q: Can I download labels for multiple orders at once?
**A:** Yes! Use the bulk download feature:
1. Select the orders you want labels for
2. Click "Bulk Actions" → "Download Labels"
3. Labels will be downloaded as a PDF

**Remember:** Labels are only available for 90 days or until delivery, whichever comes first.
...
- **Label configuration settings** - Changes won't affect already-generated labels
...
| Topic | Details |
|-------|---------|
| Label customization | Fully customizable for most carriers |
| ATS (Amazon) labels | Limited customization - provided by Amazon |
| Config changes | Apply to new shipments only, not retrospective |
| Label retention | Removed after delivery OR 90 days from manifestation |
...
| Label config not applied | Changes only affect new shipments |
| ATS label looks different | Amazon provides their own labels with limited customization |
