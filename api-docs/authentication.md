...
> ⚠️ This endpoint is **deprecated**. Migrate to the API key system above. Session tokens generated by this endpoint are short-lived (24 hours) and will be removed in a future release.
