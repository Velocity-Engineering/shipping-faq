...
### Q: Which carriers are integrated with Shipfast?

**A:** Shipfast integrates with major logistics partners in India:
...
### ⚠️ Important: Not All Carriers Support Different RTO Address
...
Shipfast automatically tries the next carrier when one fails (up to 3 attempts by default).
...
| Carrier | RTO Address | Reverse | Address Update | COD→Prepaid | QC |
|---------|-------------|---------|----------------|-------------|-----|
| Delhivery | ✅ | ✅ | ✅ | ✅ | ✅ |
| BlueDart | ✅ | ✅ | ✅ | ❌ | ❌ |
| Xpressbees | ✅ | ✅ | ❌ | ❌ | ❌ |
